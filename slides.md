...
* <!-- .element: class="fragment" --> Максимална автономия на екипа си
* <!-- .element: class="fragment" --> Минимална намеса в процесите
* <!-- .element: class="fragment" --> Свобода на служетелите да разрешават конфлитки
...
----
* <!-- .element: class="fragment" --> Анализ на сектора
...
* <!-- .element: class="fragment" --> Смесени методи за събиране на данни
