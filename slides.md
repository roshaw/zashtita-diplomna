...
* <!-- .element: class="fragment" --> Въпросникът, обследващ нивата на ЕИ у лидерите по метода на Голман – ESI (Goleman, 2000).
* <!-- .element: class="fragment" --> Въпросникът за стилове на управление на конфликти по методиката на Томас-Килман – Thomas-Kilmann Conflict Mode Instrument, TKI. 
* <!-- .element: class="fragment" --> Въпросникът за стилове на лидерство, основаващ се на трите най-често срещани стила на лидерство.
