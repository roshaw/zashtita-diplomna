...
#### <!-- .element: class="main-author" --> Дипломант **Яна Нейчева**, Магистър Бизнес психология, Ф. No 27637
...
Note:
Връзката между нивата на ЕИ
PПредпочитаните лидерски стилове
Подходи за управление на конфликти
...
* Лидери в ИТ организация
* 15 ръководителя на хора
* Опит в управление - 1-15 години
...
Note:
Основни зависимости между групите ИЛ по нива на ЕИ, УК и стил на лидерство

С тези изводи се подкрепя Хипотеза 1. ЕИ е директно свързана с начина на конфликтно управление и стила лидерство. Авторитарният стил се наблюдава при ниска ЕИ. Демократичният и Либералният стил се наблюдават при високи нива на ЕИ с добри умения за регулация на конфликтите. 
...
Хипотеза 2:
Хипотеза 2 се подкрепя, тъй като ниските нива на ЕИ се свързват с авторитарния начин на лидерство.
...
Note:
ИЛ са разделени на 3 групи - ниски нива, високи и много високи по ЕИ. 
Х4, к. предполага, че лидери, проявяващи по-силна емпатия (като компонент на ЕИ), избягват конфронтационни и агресивни подходи в конфликти, се потвърждава.
